...
def main_menu(user_account: Account) -> None:
...
def user_login(user_account: Account) -> None:
...
def character_menu(character_list: List, user_account: Account, token: str) -> None: 
...
def user_create_character(user_account: Account, character_list: List, token: str) -> None:
...
def user_delete_character(character_list: List, user_account: Account, token: str) -> None:
